...
@section('title', 'Add New Platform - Station Master')
    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">+ Add New Platform</h1>
                    <p class="text-gray-600 mt-2">Add a new platform to the station</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('station-master.platforms.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="maintenance_notes" id="maintenance_notes" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('maintenance_notes') }}</textarea>
