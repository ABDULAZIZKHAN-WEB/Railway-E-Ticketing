...
@section('title', 'Add New Station - Admin Panel')
    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">+ Add New Station</h1>
                    <p class="text-gray-600 mt-2">Fill in the details to add a new station to the system</p>
                </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="waiting_room" id="facility_waiting_room"
                                   ...
                                   {{ in_array('waiting_room', old('facilities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="restaurant" id="facility_restaurant"
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"
                                   {{ in_array('restaurant', old('facilities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="atm" id="facility_atm"
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"
                                   {{ in_array('atm', old('facilities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="parking" id="facility_parking"
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"
                                   {{ in_array('parking', old('facilities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="wifi" id="facility_wifi"
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"
                                   {{ in_array('wifi', old('facilities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="facilities[]" value="medical" id="facility_medical"
                                   class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"
                                   {{ in_array('medical', old('facilities', [])) ? 'checked' : '' }}>
