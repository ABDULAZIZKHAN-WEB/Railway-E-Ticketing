...
@section('title', 'Create Train Schedule - Admin Panel')
    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">➕ Create Train Schedule</h1>
                    <p class="text-gray-600">Add a new train schedule</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="{{ route('admin.train-schedules.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="departure_time" value="{{ old('departure_time') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="arrival_time" value="{{ old('arrival_time') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('arrival_time')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                            ...
                            @for($i = 0; $i < 7; $i++)
                                <div class="flex items-center">
                                    <input type="checkbox" name="running_days[]" value="{{ $dayValues[$i] }}" id="day_{{ $dayValues[$i] }}" 
                                        {{ in_array($dayValues[$i], old('running_days', [])) ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <input type="date" name="effective_from" value="{{ old('effective_from') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="effective_to" value="{{ old('effective_to') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('effective_to')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
